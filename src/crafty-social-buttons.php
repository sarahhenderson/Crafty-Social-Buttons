...
function SH_Crafty_Social_Buttons_RegisterWidget(){
	register_widget("SH_Crafty_Social_Buttons_Widget");
}
add_action( 'widgets_init','SH_Crafty_Social_Buttons_RegisterWidget' );